...
class CartPoleRegulatorEnv(gym.Env):
    ...
    def __init__(
        ...
        self.mode = mode
        self.max_steps = 100 if mode == "train" else 1000
...
#         elif self.group == 0:
#             self.x_success_range = 2.0
#             self.theta_success_range = 10 * 2 * math.pi / 360
    ...
    def reset(self):
        if self.mode == "train" or self.mode=='eval':
            ...
            self.state = self.np_random.uniform(low=[-self.x_success_range, 0, -self.theta_success_range, 0], high=[self.x_success_range, 0, self.theta_success_range, 0], size=(4,))
